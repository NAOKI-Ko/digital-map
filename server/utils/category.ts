...
export const spotCategorySelect = {
  category: {
    select: { id: true, name: true, order: true, iconType: true, iconPresetId: true, iconImageUrl: true, iconAssetId: true, iconAsset: { select: { storageKey: true, variants: true } }, translations: { select: { locale: true, name: true } } },
  },
