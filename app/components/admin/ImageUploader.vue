...
<template>
  <div>
    ...
    <div v-else class="rounded-xl border border-stone-200 bg-white p-4">
      ...
      <div class="mt-3 flex flex-wrap gap-2">
        ...
        <button type="button" :disabled="isUploading" class="rounded-lg border border-stone-300 px-4 py-2 text-sm font-semibold" @click="chooseFile">画像を選び直す</button>
        <button type="button" :disabled="isUploading" class="rounded-lg px-4 py-2 text-sm" @click="clearSelection">キャンセル</button>
      </div>
    </div>
