...
<template>
  <div class="max-w-4xl">
    ...
    <template v-else>
      ...
      <NuxtLink v-if="data.spot.lat === null || data.spot.lng === null" :to="{ path: `/admin/maps/${mapId}/editor`, query: { floorId: data.spot.floorId, placeSpotId: data.spot.id } }" class="mt-5 inline-flex rounded-lg bg-terracotta-600 px-4 py-2.5 text-sm font-semibold text-white">地図上に配置する</NuxtLink>
