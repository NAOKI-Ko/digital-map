...
| WU-13 | KAN-11/14/31 | PASS | PENDING COMMIT | Added independent small/medium/large pin size with medium migration default. Density uses discrete visibility: selected, active-category, featured, then normal; selected/filter matches bypass suppression, featured survives far zoom, and no opacity fade or user numeric tuning remains. Full 35 files / 269 tests and typecheck PASS. |
