...
| WU-11 | KAN-44/37 | PASS | PENDING COMMIT | Creation begins with enabled Illustration versus visibly disabled future Real Map, accepts name and stable public slug, creates default Spot fields, and enters a setup checklist. Tourism categories are opt-in alongside custom names; georeference and branding remain optional. No GEO persistence added. Full 34 files / 265 tests and typecheck PASS. |
