...
| WU-19 | KAN-46 | PASS | PENDING COMMIT | Same-name lookup is case-insensitive and limited to the owned Map; edit excludes itself. Create/update shows Floor, Category and placement context and requires an explicit continue while leaving duplicates legal. Full 39 files / 286 tests, typecheck and build PASS. |
