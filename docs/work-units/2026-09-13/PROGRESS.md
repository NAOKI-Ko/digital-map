...
| WU-02 | KAN-7/40/49 | PASS | PENDING COMMIT | Replacement updates only image reference/dimensions and preserves normalized placement/georeference; selected-image preview/choose-again/reset UX; focused 7 tests, full 26 files / 223 tests, typecheck PASS. |
