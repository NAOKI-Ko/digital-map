...
| WU-09 | KAN-38 | PASS | PENDING COMMIT | Existing Spot addresses can produce selectable geocoder candidates only on georeferenced Floors; candidates convert to temporary IMAGE x/y, reject out-of-Floor results, remain adjustable, and persist only through the explicit position save. Full 32 files / 254 tests and typecheck PASS. |
