...
Both paths passed. Windows QA then applied all 30 migrations from exact implementation SHA `8c4675ee019cbfcde06fe9964fcb05a70b699b94`; `Map_tenantId_key` is active, every Tenant has at most one Map, and direct/concurrent second-Map tests passed in the isolated PostgreSQL suite.
...
The retained recovery points include the pre-cleanup backup `pre-wu49-cleanup-7c57e57-20260920-053426`, the post-deploy backup `post-wu49-unblock-8c4675e-20260920-064305`, and all pre-existing release/backup folders.
